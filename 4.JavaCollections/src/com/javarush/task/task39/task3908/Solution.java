...
public class Solution {
   ...
   // System.out.print(isPalindromePermutation("арозаупаланалапуазора"));
    }
...
StringBuilder stringBuilder = new StringBuilder(s_new);
        StringBuilder stringBuilder_new = stringBuilder.reverse();
return s_new.equals(stringBuilder_new.toString());*/
