...
public class Solution {
    ...
    public static String weekDayOfBirthday(String birthday, String year) {
       ...
       // DateTimeFormatter ff =  DateTimeFormatter.ofPattern("YYYY", Locale.ITALIAN);
        LocalDate birth = LocalDate.parse(birthday,f);

        birth = birth.with(Year.parse(year));
       // Year y = Year.parse(year, ff);
        return birth.getDayOfWeek().getDisplayName(TextStyle.FULL,Locale.ITALIAN) ;
