        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            for (int i = 0; reader.ready() == true; i++) {
                ...
                if (bDate.equals("null"))
                    users.get(i).setBirthDate(null);
                 else
                     users.get(i).setBirthDate(Date.valueOf(bDate));//user.setBirthDate(Date.valueOf(tmpMass[2]));
                ...
                users.get(i).setCountry( User.Country.valueOf(c));
            }
            reader.close();
        }
